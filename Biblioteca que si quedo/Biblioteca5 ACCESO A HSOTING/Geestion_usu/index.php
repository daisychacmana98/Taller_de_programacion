...
echo "<tr>";
echo "<td><span class='editable'>" . limpiar($fila["id"], $conn) . "</span></td>";
echo "<td><span class='editable'>" . limpiar($fila["codigo"], $conn) . "</span></td>";
echo "<td><span class='editable'>" . limpiar($fila["nombre"], $conn) . "</span></td>";
echo "<td><span class='editable'>" . limpiar($fila["telefono"], $conn) . "</span></td>";
echo "<td><span class='editable'>" . limpiar($fila["direccion"], $conn) . "</span></td>";
