...
function calcularTotal($productos) {
    // Supongamos que aquí se aplica algún tipo de impuesto o descuento
    // en este caso, simplemente retornaremos el subtotal
...
function vaciarCarrito() {
    // Supongamos que tienes un arreglo $carrito que contiene los productos en el carrito
    // Puedes reiniciarlo vaciándolo
    global $carrito;
    $carrito = array();
}
